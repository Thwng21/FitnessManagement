...
export default function RegisterPage() {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center p-4 bg-black overflow-hidden">
      ...
      {/* Decorative Circles */}
      <div className="absolute top-[-10%] right-[-10%] w-[40%] h-[40%] bg-emerald-500/10 rounded-full blur-[120px] z-10" />
      <div className="absolute bottom-[-10%] left-[-10%] w-[40%] h-[40%] bg-teal-500/10 rounded-full blur-[120px] z-10" />
      ...
      <div className="relative z-20 max-w-lg w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 font-medium">Khởi đầu hành trình thay đổi vóc dáng của bạn hôm nay</p>
        </div>
        ...
        <div className="bg-white/5 backdrop-blur-2xl border border-white/10 p-8 md:p-10 rounded-[2.5rem] shadow-2xl relative overflow-hidden group">
          ...
          <form className="space-y-6 relative z-10" onSubmit={handleSubmit}>
            ...
            <div className="space-y-2">
              <label className="text-xs font-black text-gray-400 uppercase tracking-widest ml-1">Mật khẩu bảo mật</label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-gray-500">
          ...
          <div className="mt-8 text-center relative z-10">
            <p className="text-sm text-gray-500 font-medium">
              Đã có tài khoản?{' '}
              <Link href="/auth/login" className="font-black text-white hover:text-emerald-500 transition-colors underline decoration-emerald-500/30 decoration-2 underline-offset-4">
                ĐĂNG NHẬP NGAY
              </Link>
            </p>
          </div>
